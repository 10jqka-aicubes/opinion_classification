    ...
    def _create_example(self):
        ...
        for sentence in self._current_sentences:
            ...
            if (
                ...
                or (second_segment and len(first_segment) < first_segment_target_length and random.random() < 0.5)
            ):
    ...
    def __init__(
        ...
        for i in range(num_out_files):
            if i % num_jobs == job_id:
                ...
                self._writers.append(tf.python_io.TFRecordWriter(output_fname))
        self.n_written = 0
